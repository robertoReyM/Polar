...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView tvNotRegistered = (TextView) findViewById(R.id.tv_not_registered);
        tvNotRegistered.setOnClickListener(new OnClickListener() {
            @Override
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            showProgress(true);
            WebServices.userLogin(email, password, new WebServices.OnSessionListener() {
                @Override
